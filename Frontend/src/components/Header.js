...
import Logo from '../utils/iot_solutions-high-resolution-logo.png';
  ...
  return (
    ...
    <nav class="border-gray-200 px-4 lg:px-6 py-2.5 bg-black">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            {/* <h1 className='text-white'>IOT Solutions..</h1> */}
            <img src={Logo} alt="logo" className='w-32 h-10 cursor-pointer object-center object-cover' />
